...
public class OrgUnitByIdQuery implements DataFetcher<OrgUnit> {

	
	private OrgUnitRepository orgUnitRepository;
	
	
	public OrgUnitByIdQuery(OrgUnitRepository orgUnitRepository) {
		super();
	...
	public OrgUnit get(DataFetchingEnvironment environment) {
		...
		return orgUnitRepository.get(environment.getArgument("id"));
	}
